...
```
>[!NOTE]
> - Example project: [Sample Windows project .csproj](./AWV.WebView.Avalonia.Sample.Windows/AWV.WebView.Avalonia.Sample.Windows.csproj)
> - Example usage in XAML: [MainView.axaml](./AWV.WebView.Avalonia.Sample/Views/MainView.axaml)
---
### Linux
